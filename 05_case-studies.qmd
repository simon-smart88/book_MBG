...
## Mapping stunting and underweight risk in Ghana {#sec-ghana}
...
```{r}
#| label: fig-maln-pit
#| fig-cap: "Assessment of the models calibration. The left panel shows the probability integral transform (PIT) curve for HAZ, and the right panel for WAZ. In both panels, the red dashed line corresponds to the identity line."
#| fig-width: 10
#| fig-height: 4
